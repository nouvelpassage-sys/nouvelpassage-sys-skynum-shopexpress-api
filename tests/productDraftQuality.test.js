...
const baseDraft = {
  ...
  category: "Букети",
  descriptionUk:
    "Букет Lumiere Douce виглядає зібрано й дорого завдяки загальному настрою, формі та м'якій подачі. Така позиція доречна для привітання, побачення або особистого компліменту без технічного переліку складу.",
  seo: {
