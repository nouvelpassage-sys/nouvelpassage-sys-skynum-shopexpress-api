    ...
    const userContent = [
      {
        ...
        text: JSON.stringify({
          ...
          businessRules: {
            ...
            bouquetAvailabilityNote:
              "Every Ukrainian description for a bouquet or flower box must end with exactly this note: 'У разі відсутності окремих позицій можливе коригування складу: окремі квіти можуть бути замінені на аналогічні або дорожчі за наш рахунок із збереженням стилю, кольорової гами, форми та загального характеру букета.' Do not put this note at the beginning or duplicate it.",
